        ...
        <div class="header-inner">
            <div class="col-sm-4 col-xs-6 header-left">
                <div class="shipping">
                    ...
                    <div class="shipping-text">+91(000)1234-1234<span class="shipping-detail">Week From 9:00am To
                            7:00pm</span></div>
                </div>
            </div>
            <div class="col-sm-4 col-xs-12 header-middle">
                <div class="header-middle-top">
                    <div id="logo"> <a href="index.html"><img src="{{ asset('themes/images/logo.png') }}" title="E-Commerce" alt="E-Commerce"
                                ...
                                <tbody>
                                    <tr>
                                        <td class="text-center"><a href="#"><img class="img-thumbnail"
                                                    ...
                                                    src="{{ asset('themes/images/image/product/7product50x59.jpg') }}"></a></td>
                        ...
                        <li>
                            <div>
                                ...
                                <p class="text-right"> <span class="btn-viewcart"><a href="cart.html"><strong><i
                                        ...
                                        class="btn-checkout"><a href="checkout.html"><strong><i class="fa fa-share"></i>
